...
# sequences to be aligned - prefix-encoded (PE) sequence
...
#    Analyze groups of patients with the last indicator of the state of the disease cod_activdade_das
#    df2 = pd.read_csv('C:/Users/kisha_000/Desktop/tese/Temporal Needleman Wunsch/actividade_doenca_sequence.csv',sep = ';')
#    df2.dropna(inplace = True)
#    #reset index to make from 0 to len(dataframe)
#    df2 = df2.reset_index(drop=True)
#    df2 = df2.groupby('id_doente').last()
#    df2 = df2.reset_index()
#    lista = df2.groupby('cod_actividade_das')['id_doente'].apply(list)